...
def get_options(arguments):
    ...
    parser.add_option('', '--description-file', dest='description_file',
                      type="string",
    ...
    parser.add_option('', '--location', dest='location', type="string",
                      ...
                      help='Video location"')
    parser.add_option('', '--recording-date', dest='recording_date',
                      metavar="datetime",
                      default=None,
                      help="Recording date (ISO 8601): YYYY-MM-DDThh:mm:ss.sZ")
    parser.add_option('', '--default-language', dest='default_language',
                      type="string",
                      default=None, metavar="string",
                      help="Default language (ISO 639-1: en | fr | de | ...)")
    parser.add_option('', '--default-audio-language',
                      dest='default_audio_language', type="string",
                      default=None, metavar="string",
    ...
    parser.add_option('', '--title-template', dest='title_template',
                      type="string", default="{title} [{n}/{total}]",
                      metavar="string",
    ...
    parser.add_option('', '--auth-browser', dest='auth_browser',
                      action='store_true',
